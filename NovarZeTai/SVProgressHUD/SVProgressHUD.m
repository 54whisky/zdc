...
- (void)dismiss;
- (void)dismissWithStatus:(NSString*)string error:(int)error;
- (void)dismissWithStatus:(NSString*)string error:(int)error afterDelay:(NSTimeInterval)seconds;
...
+ (void)showInfoWithStatus:(NSString *)string{
    [SVProgressHUD showInfoWithStatus:string duration:1];
}

+ (void)showInfoWithStatus:(NSString *)string duration:(NSTimeInterval)duration{
    [SVProgressHUD show];
    [SVProgressHUD dismissWithInfo:string afterDelay:duration];
}
...
+ (void)dismissWithSuccess:(NSString*)successString {
	[[SVProgressHUD sharedView] dismissWithStatus:successString error:0];
}

+ (void)dismissWithSuccess:(NSString *)successString afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUD sharedView] dismissWithStatus:successString error:0 afterDelay:seconds];
}

+ (void)dismissWithError:(NSString*)errorString {
	[[SVProgressHUD sharedView] dismissWithStatus:errorString error:1];
}

+ (void)dismissWithError:(NSString *)errorString afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUD sharedView] dismissWithStatus:errorString error:1 afterDelay:seconds];
}

+ (void)dismissWithInfo:(NSString *)errorString{
    [[SVProgressHUD sharedView] dismissWithStatus:errorString error:2];
}

+ (void)dismissWithInfo:(NSString *)errorString afterDelay:(NSTimeInterval)seconds{
    [[SVProgressHUD sharedView] dismissWithStatus:errorString error:2 afterDelay:seconds];
}
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        switch (error) {
            ...
            case 1:
                ...
                break;
            case 2:
                self.imageView.image = [UIImage imageNamed:@"SVProgressHUD.bundle/info.png"];
                break;
            default:
                break;
        }
